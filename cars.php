...
Author: Volodymyr Marakhovskiy
Version: 1.0
*/
/*  Copyright  2018  Volodymyr Marakhovskiy  (email: E-MAIL_АВТОРА)
...
register_deactivation_hook(__FILE__,'cars_uninstall');


function vm_create_post_type()
{
    register_post_type('vm_cars',
        [
            'labels' => [
                'name' => _('Cars'),
                'singular_name' => _('Car'),
            ...
            'menu_position' => 5,
            'supports' => ['title', 'editor', 'post-formats', 'excerpt'],
            'public' => true,
            'has_archive' => true,
...
add_action('init', 'vm_create_post_type');
...
//add_action( 'init', 'create_model', 0 );
...
//        'labels' => array(
//            'name' => _x( 'Категории автомобилей', 'taxonomy general name' ), // Общее название таксономии, используется во множественном числе. Соответствует значению label. По умолчанию: _x( 'Метки', 'taxonomy general name' ) или _x( 'Рубрики', 'taxonomy general name' ).
//            'singular_name' => _x( 'Категория автомобилей', 'taxonomy singular name' ), // Название таксономии в единственном числе. По умолчанию: _x( 'Метка', 'taxonomy singular name' ) или _x( 'Рубрика', 'taxonomy singular name' ).
//            'menu_name' => __( 'Категории автомобилей' ), // Название таксономии в пункте меню. Если не задается, то используется значение label. По умолчанию: 'Метки' или 'Рубрики'.
//            'all_items' => __( 'Все категории автомобилей' ), // Текст всех таксономий. По умолчанию: __( 'Все метки' ) или __( 'Все рубрики' ).
//            'edit_item' => __( 'Изменить категорию автомобилей' ), // Текст изменения таксономии на странице ее редактирования. По умолчанию: __( 'Изменить метку' ) или __( 'Изменить рубрику' ).
//            'view_item' => __( 'Просмотреть категорию автомобилей' ), // Текст просмотра таксономии, который появляется в навигационном баре админ-панели на странице редактирования данной таксономии. По умолчанию: __( 'Просмотреть метку' ) или __( 'Просмотреть рубрику' ).
//            'update_item' => __( 'Обновить категорию автомобилей' ), // Текст обновления таксономии во вкладке свойства. По умолчанию: __( 'Обновить метку' ) или __( 'Обновить рубрику' ).
//            'add_new_item' => __( 'Добавить новую категорию автомобилей' ), // Текст добавления новой таксономии при ее создании. По умолчанию: __( 'Добавить новую метку' ) или __( 'Добавить новую рубрику' ).
...
//            'search_items' => __( 'Поиск категорий автомобилей' ), // Текст в кнопке поиска на странице всех таксономий. По умолчанию: __( 'Поиск меток' ) или __( 'Поиск рубрик' ).
...
//            'not_found' => __( 'Категорий автомобилей не найдено.' ), // Текст в случае, если запрашиваемая таксономия не найдена. По умолчанию: __( 'Меток не найдено.' ) или __( 'Рубрик не найдено.' ).
//        ),
...
//        'rewrite' => array(
//            'slug' => 'model', // Текст в ЧПУ. По умолчанию: название таксономии.
...
//    );
//    register_taxonomy( 'model', array('cars'), $args );
//}
//
...
//    if ( $taxonomy !== 'model' )
//        return $link;
//    return str_replace( 'model/', '', $link );
//}
//add_filter( 'term_link', 'taxonomy_link', 10, 3 );
//
//// Редирект:
//function taxonomy_rewrite_rule() {
//    add_rewrite_rule('allmodels/?$', 'index.php?models=allmodels', 'top');
//}
//
//
...
//    $args = array(
//        'label'  => _x( 'Cars', 'Post Type General Name', 'text_domain' ), // Название пользовательского типа записи во множественном числе. По умолчанию: значение аргумента 'name' массива 'labels'.
//        'labels' => array(
//            'name' => _x( 'Cars', 'Post Type General Name', 'text_domain' ), // Общее название пользовательского типа записи во множественном числе. Переопределяет значение 'label'. По умолчанию: _x( 'Записи', 'Post Type General Name', 'text_domain' ) или _x( 'Страницы', 'Post Type General Name', 'text_domain' ).
//            'singular_name' => _x( 'Car', 'Post Type Singular Name', 'text_domain' ), // Название пользовательского типа записи в единственном числе. По умолчанию: _x( 'Запись', 'Post Type Singular Name', 'text_domain' ) или _x( 'Страница', 'Post Type Singular Name', 'text_domain' ).
...
//            'add_new_item' => __( 'Добавить Car', 'text_domain' ), // Текст добавления нового объекта типа записи на странице создания. По умолчанию: __( 'Добавить запись', 'text_domain' ) или __( 'Добавить страницу', 'text_domain' ).
//            'edit_item' => __( 'Редактировать Car', 'text_domain' ), // Текст редактирования объекта типа записи на странице редактирования. По умолчанию: __( 'Редактировать запись', 'text_domain' ) или __( 'Редактировать страницу', 'text_domain' ).
//            'new_item' => __( 'New Car', 'text_domain' ), // Текст новой объекта типа записи. По умолчанию: __( 'Новая запись', 'text_domain' ) или __( 'Новая страница', 'text_domain' ).
//            'view_item' => __( 'Просмотреть запись Cars', 'text_domain' ), // Текст просмотра типа записи в админ-баре. По умолчанию: __( 'Просмотреть запись', 'text_domain' ) или __( 'Просмотреть страницу', 'text_domain' ).
//            'search_items' => __( 'Поиск Cars', 'text_domain' ), // Текст на кнопке поиска объектов данного типа записи. По умолчанию: __( 'Поиск записей', 'text_domain' ) или __( 'Поиск страниц', 'text_domain' ).
//            'not_found' => __( 'Cars не найдено', 'text_domain' ), // Текст в случае отрицательного результата поиска объектов данного типа записи. По умолчанию: __( 'Записей не найдено', 'text_domain' ) или __( 'Страниц не найдено', 'text_domain' ).
//            'not_found_in_trash' => __( 'Cars в корзине не найдено', 'text_domain' ), // Текст в случае отрицательного результата поиска объектов данного типа записи в корзине. По умолчанию: __( 'Записей в корзине не найдено', 'text_domain' ) или __( 'Страниц в корзине не найдено', 'text_domain' ).
...
//            'all_items' => __( 'Все cars', 'text_domain' ), // Текст всех объектов типа записи в подменю. По умолчанию: __( 'Все записи', 'text_domain' ) или __( 'Все страницы', 'text_domain' ).
//            'archives' => __( 'Архивы cars', 'text_domain' ), // Текст архивов типа записи. По умолчанию: __( 'Архивы записей', 'text_domain' ) или __( 'Архивы страниц', 'text_domain' ).
//            'insert_into_item' => __( 'Вставить в cars', 'text_domain' ), // Текст добавления медиафайлов в объект типа записи во вкладке 'Добавить медиазапись'. По умолчанию: __( 'Вставить в запись', 'text_domain' ) или __( 'Вставить в страницу', 'text_domain' ).
...
//            'menu_name' => __( 'Cars', 'text_domain' ), // Текст в пункте меню. По умолчанию: значение аргумента 'name'.
...
//            'edit_post' => 'edit_cars',
//            'read_post' => 'read_cars',
//            'delete_post' => 'delete_cars',
//            'edit_posts' => 'edit_cars',
//            'edit_others_posts' => 'edit_others_cars',
//            'publish_posts' => 'publish_cars',
//            'read_private_posts' => 'read_private_cars',
//            'create_posts' => 'edit_cars',
//        ),
//        */
...
//        'taxonomies' => array('model'), // Массив связанных таксономий для данного типа записи. Пользовательскую таксономию необходимо зарегестрировать через функцию register_taxonomy(). По умолчанию: без таксономий.
...
//        'rewrite' => array(
//            'slug' => 'cars', // Текст в ссылке. По умолчанию: значение $post_type.
//            'with_front' => false, // Должна ли структура ссылки быть с базовым URL. Пример: если структура ссылки /blog/, то ссылка при соответствующих параметрах 'with_front' выглядит так: false->/cars/, true->/blog/cars/). По умолчанию: true.
...
//        'rest_base' => null, // Базовый ярлык данного типа записи когда доступно использование REST API. По умолчанию: значение $post_type.
